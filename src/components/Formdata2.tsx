...
const MyComponent: React.FC = () => {
  ...
  const [formData, setFormData] = useState<FormData>({
    input1: baseData.input1,
    input2: baseData.input2,
    input3: baseData.input3,
    dropdown1: baseData.dropdown1,
    dropdown2: baseData.dropdown2,
    dropdown3: baseData.dropdown3,
    dropdown4: baseData.dropdown4,
  });
