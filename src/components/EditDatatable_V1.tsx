    ...
    return (
      <InputText
        ...
        onChange={(e) => {
          ...
          const index = newProductData.findIndex((product) => product.id === rowData.id);
          newProductData[index].product_fa_code = e.target.value;
    ...
    return (
      <InputText
        ...
        onChange={(e) => {
          const newProductData = [...productData];
          const index = newProductData.findIndex((product) => product.id === rowData.id);
          newProductData[index].product_alt_fa_code = e.target.value;
          setProductData(newProductData);
        }}
      />
    );
  ...
  const onSaveButtonClick = () => {
    ...
    productData.forEach((product) => {
      const newProduct: IProduct = {
        ...product,
        product_fa_code: product.product_fa_code || '',
        product_alt_fa_code: product.product_alt_fa_code || '',
      };
